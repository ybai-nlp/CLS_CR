...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        if compression_rate is not None:
            ...
            net_input['compression_rate'] = encoder_compression_rate
            # print("net input = ")
            # for each in net_input:
            #     print(each, ": ", net_input[each].size())
            #     print(net_input[each])
            # print("encoder compression_rate = ", compression_rate)
        # exit()
        ...
        # compression_rate = compression_rate.repeat(beam_size)
        ...
        ## 在这里改开头的token吧。但似乎只能改一个，我得继续自定义才行。
...
class EnsembleModel(nn.Module):
    ...
    def forward_decoder(
        ...
        # print("compression_rate in emsemble", compression_rate)
        log_probs = []
        ...
        for i, model in enumerate(self.models):
            ...
            if self.has_incremental_states():
                ...
                if hasattr(model, "decoder"):
                    decoder_out = model.decoder.forward(tokens, encoder_out=encoder_out, compression_rate=compression_rate)
                else:
