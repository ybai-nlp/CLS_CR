...
class LabelSmoothedCrossEntropyCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        # exit()
        loss, nll_loss = self.compute_loss(model, net_output, sample, reduce=reduce, cr_rate=cr_rate)
        sample_size = (
    ...
    def compute_loss(self, model, net_output, sample, reduce=True, cr_rate=None):
        ...
        # 这里loss是label smooth之后的，nllloss是label smoothing之前的
        ...
        if cr_rate is not None:
            ...
            # l1_loss = torch.nn.functional.l1_loss(attn, l1_target, reduction='none')
            # exit()
